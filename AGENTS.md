...
The `oe-cli` skill is the agent-facing operating manual for this CLI. Whenever the CLI command surface, graph model, or recommended workflow changes, update both bundled copies:
