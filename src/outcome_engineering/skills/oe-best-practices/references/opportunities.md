...
2. Keep solutions out.
   Do not name features, services, workflows, documents, prompts, automations, or implementation ideas. Those belong in solutions.

3. Pass the multiple-solutions test.
   If only one plausible solution can address it, ask "why?" until you find the underlying need.

4. Make it specific and evidenced.
   Ground it in customer stories, interviews, observed behavior, or a clearly marked hypothesis. Avoid vague themes like "make it easier."

5. Tie it to one parent outcome.
...
- Solution-shaped: `Add guided opportunity templates`
- Opportunity-shaped: `Practitioners cannot reliably phrase opportunities as customer needs`

- Company-shaped: `Practitioners create cleaner graphs`
- Customer-shaped: `I cannot tell whether this idea is an opportunity or a solution`
