...
- MVP'en viser mindst tre datakvalitetsindikatorer med status, ejer, berørte systemer og seneste opdatering.
- Kendte afvigelser kan beskrives i både fagligt og teknisk sprog.
- Brugere kan abonnere på status for relevante systemer eller datatyper.
- Afvigelser kan lukkes med kort forklaring og historik.
